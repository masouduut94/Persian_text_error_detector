...
elif dataset_name == "persian":
    datasets = data_helpers.get_datasets_persianText(cfg["datasets"][dataset_name]["add"]["path"],
                                                     cfg["datasets"][dataset_name]["noerror"]["path"],
                                                     cfg["datasets"][dataset_name]["remove"]["path"],
                                                     cfg["datasets"][dataset_name]["replace"]["path"],
                                                     cfg["datasets"][dataset_name]["zamir"]["path"])
    print("persian :)")
